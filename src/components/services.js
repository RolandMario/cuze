  ...
  return (
    <div className=" lg:mx-1">
        ...
        <div className="  sm:flex flex-wrap lg:gap-3">
             <Card imageSrc={folder} caption={"Data Protection"} desc={"Gap Analysis | DPIA "} id={"privacy"}/>
             <Card imageSrc={hacker} caption={"Cyber Security"} desc={"  Risks Analysis | ISO 27001 "} id={"security"}/>
             <Card imageSrc={remote_access} caption={"Information Technology"} desc={" Database | Software"} id={"it"}/>
             <Card imageSrc={project_management} caption={"Project Management"} desc={" Agile| Scrum Master"} id={"pmt"}/>
        </div>
...
function Card({imageSrc, caption, id}){
    return(
       ...
       sm:w-64 lg:w-56 xl:w-64
        ...
        >
            ...
            <div className=" pb-5">
                <p className="text-blue-950 text-l"><strong><Link href={`/services/#${id}`}>Learn More ---</Link></strong></p>
            </div>
